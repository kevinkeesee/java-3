...
class Regex {
    public static void main(String[] args) {
        ...
        System.out.println("The following pattern ('\\d'){36} matches a line of 36 digits in succession.");
        ...
        for (int i = 0; i < TEKmentors.length; i++){
        	tekMentors[i] = TEKmentors[i].replaceAll("\\s\\S+", "");
        }
        
        for (String e : tekMentors) {
        	System.out.print(e + ", ");
        }
        ...
        System.out.println("The above string contains " + bookCount + " instances of the word 'book'");
        ...
        String happy = notSleepy.replaceAll("sleepy", "happy");
